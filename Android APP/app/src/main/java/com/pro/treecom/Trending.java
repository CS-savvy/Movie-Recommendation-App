...
public class Trending extends android.support.v4.app.Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, @Nullable ViewGroup container, Bundle savedInstanceState) {
        ...
        View v = inflater.inflate(R.layout.frag_trending, container ,false);
        trend_list = (RecyclerView)v.findViewById(R.id.trend_list);
        return v;
    ...
    public void onViewCreated(View view ,@Nullable Bundle savedInstanceState){
        ...
        mbDatabase = FirebaseDatabase.getInstance().getReference().child("Trending").child("Data");
        ...
        trend_list.setLayoutManager(l2);
    ...
    public void onStart()
    {
        ...
        FirebaseRecyclerAdapter<Ybox,TrendViewHolder> firebaseRecyclerAdapter = new FirebaseRecyclerAdapter<Ybox, TrendViewHolder>(
                Ybox.class,
                R.layout.card,
                TrendViewHolder.class,
                mbDatabase
        ) {
            @Override
            protected void populateViewHolder(TrendViewHolder viewHolder, Ybox model, int position) {
                ...
                viewHolder.setOnSmilySelectionListener(new TrendViewHolder.RateListener(){
                    @Override
            ...
            public TrendViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
                TrendViewHolder viewHolder = super.onCreateViewHolder(parent, viewType);

                viewHolder.setOnClickListener(new TrendViewHolder.ClickListener() {
                    @Override
        ...
        trend_list.setAdapter(firebaseRecyclerAdapter);
    ...
    public static class TrendViewHolder extends RecyclerView.ViewHolder
    {
        ...
        private TrendViewHolder.RateListener mRateListener;

        public interface RateListener{
            public void onSmileySelected(int smiley , boolean reselected, String card_id);
        }

        public void setOnSmilySelectionListener(TrendViewHolder.RateListener rateListener)
        {
        ...
        private TrendViewHolder.ClickListener mClickListener;

        public interface ClickListener{
            public void onItemClick(View view, int position ,String url);
        }

        public void setOnClickListener(TrendViewHolder.ClickListener clickListener){
