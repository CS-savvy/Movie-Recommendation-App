...
public class Recom extends android.support.v4.app.Fragment {

    private RecyclerView mrecom_list;
    ...
    public View onCreateView(LayoutInflater inflater, @Nullable ViewGroup container, Bundle savedInstanceState) {
        ...
        View v = inflater.inflate(R.layout.frag_recom , container ,false);
        mrecom_list = (RecyclerView)v.findViewById(R.id.recom_list);
        return v;
   ...
   public void onViewCreated(View view ,@Nullable Bundle savedInstanceState){
        ...
        mbDatabase = FirebaseDatabase.getInstance().getReference().child("CurrentFeedback").child(user_id).child("name").child("Data");
        ...
        mrecom_list.setLayoutManager(l2);
    ...
    public void onStart()
    {
        ...
        FirebaseRecyclerAdapter<Ybox,RecomViewHolder> firebaseRecyclerAdapter = new FirebaseRecyclerAdapter<Ybox, RecomViewHolder>(
                Ybox.class,
                R.layout.card,
                RecomViewHolder.class,
                mbDatabase
        ) {
            @Override
            protected void populateViewHolder(RecomViewHolder viewHolder, Ybox model, int position) {
                ...
                viewHolder.setOnSmilySelectionListener(new RecomViewHolder.RateListener(){
                    @Override
            ...
            public RecomViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
                RecomViewHolder viewHolder = super.onCreateViewHolder(parent, viewType);

                viewHolder.setOnClickListener(new RecomViewHolder.ClickListener() {
                    @Override
        ...
        mrecom_list.setAdapter(firebaseRecyclerAdapter);
    ...
    public static class RecomViewHolder extends RecyclerView.ViewHolder
    {
        ...
        private RecomViewHolder.RateListener mRateListener;

        public interface RateListener{
            public void onSmileySelected(int smiley , boolean reselected, String card_id);
        }

        public void setOnSmilySelectionListener(RecomViewHolder.RateListener rateListener)
        {
        ...
        private RecomViewHolder.ClickListener mClickListener;

        public interface ClickListener{
            public void onItemClick(View view, int position ,String url);
        }

        public void setOnClickListener(RecomViewHolder.ClickListener clickListener){
